...
namespace Instrumusicals.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var instrumusicalsContext = _context.Review.Include(r => r.Instrument);
        ...
        public async Task<IActionResult> Create([Bind("Id,InstrumentId,Created,LastUpdate,Content")] Review review)
        {
            ...
            ViewData["InstrumentId"] = new SelectList(_context.Instrument, "Id", "Name", review.InstrumentId);
            return View(review);
        }
